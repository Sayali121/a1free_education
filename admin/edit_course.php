...
if(!isset($_SESSION['a1free']))
{
	...
	$query=mysqli_query($connection,"select * from `course` where course_id='$course_id'");
                ...
                <h2>Edit Course</h2>
                    ...
                    <div class="card">
                        <div class="form-group form-float"><br>
								...
								<div class="form-group form-float"><br>
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="eligibility" value="<?php echo $row['eligibility'];?>">
								...
								<div class="form-group form-float"><br>
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="scholarship" value="<?php echo $row['scholarship'];?>">
