...
if(!isset($_SESSION['quiz']))
{
	...
	include('conn.php');
	$s_id=$_GET['s_id'];
	$query=mysqli_query($connection,"select * from `subject` where s_id='$s_id'");
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST" action="update_subject.php?s_id=<?php echo $s_id; ?>">
							<div class="row">
							<div class="col-lg-6">
...
<select name="c_id" class="form-control">
    ...
    <?php
        include "conn.php";  
        $records = mysqli_query($connection, "SELECT * From class");  

        while($data = mysqli_fetch_array($records))
        {
            echo "<option value='". $data['c_id'] ."'>" .$data['class'] ."</option>";  
        }	
    ?>  
  </select>
							...
							<div class="col-lg-6">
                                ...
                                <center><button class="btn btn-primary waves-effect" type="submit">SUBMIT</button></center>
                            </form>
                        </div>
						</div>
                    </div>
