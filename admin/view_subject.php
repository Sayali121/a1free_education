...
if(!isset($_SESSION['quiz']))
{
 ...
 include('conn.php');
 $sql = "SELECT * FROM subject INNER JOIN class ON subject.c_id = class.c_id";  
...
?>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <a href="exportsubject.php" class="btn btn-primary"><i class="exp"></i> Export</a>
        </div>
                    <div class="card">
                        <div class="header">
                                    ...
                                    <tr>
									   ...
									   <td><?php echo $row['s_id']; ?></td>
										...
										<td><?php echo $row['subject_name']; ?></td>
                                         ...
                                         <td>
                <a href="edit_subject.php?s_id=<?php echo $row['s_id']; ?>"><button type="button" class="btn bg-deep-orange waves-effect m-r-20"><i class="material-icons">create</i></button></a>
                <a href="delete_subject.php?s_id=<?php echo $row['s_id']; ?>"><button type="button" class="btn bg-red waves-effect m-r-20"><i class="material-icons">delete</i></button></a>
              </td>
                                    </tr>
									<?php
							   } }?>
