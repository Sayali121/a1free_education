...
<body class="theme-red">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <a href="exportclass.php" class="btn btn-primary"><i class="exp"></i> Export</a>
        </div>
                    <div class="card">
                                    ...
                                    <tr>
									   <td><?php echo $row['course_id']; ?></td>
										...
										<td><?php echo $row['scholarship']; ?></td>
                                         <td>
                <a href="edit_course.php?course_id=<?php echo $row['course_id']; ?>"><button type="button" class="btn bg-deep-orange waves-effect m-r-20"><i class="material-icons">create</i></button></a>
                <a href="delete_course.php?course_id=<?php echo $row['course_id']; ?>"><button type="button" class="btn bg-red waves-effect m-r-20"><i class="material-icons">delete</i></button></a>
              </td>
                                    </tr>
									<?php
          }
