...
if(!isset($_SESSION['quiz']))
{
	...
	include('conn.php');
	$ch_id=$_GET['ch_id'];
	$query=mysqli_query($connection,"select * from `chapter` where ch_id='$ch_id'");
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST" action="update_chapter.php?ch_id=<?php echo $ch_id;?>">
							<div class="row">
							<div class="col-lg-3">
       ...
       <?php }} ?>
							  ...
							  <div class="col-lg-3">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="chap_name" value="<?php echo $row['chap_name'];?>">
