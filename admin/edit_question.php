...
if(!isset($_SESSION['quiz']))
{
	...
	include('conn.php');
	$q_id=$_GET['q_id'];
	$query=mysqli_query($connection,"select * from `question` where q_id='$q_id'");
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST" action="update_question.php?q_id=<?php echo $q_id;?>">
							<div class="row">
							<div class="col-lg-3">
       ...
       <?php }} ?>
							  ...
							  <div class="col-lg-4">
							   ...
							   <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="repeated" value="<?php echo $row['repeated'];?>">
