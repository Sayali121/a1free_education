...
<head>
    ...
    <title>Welcome To | A-1 Free Education</title>
    <!-- Favicon-->
...
<body class="theme-red">
  ...
  $sql = "SELECT COUNT(`u_name`) AS total_name FROM `user`";
...
?>
  ...
  $sql = "SELECT COUNT(`class`) AS total_name FROM `class`";
  $result = mysqli_query($connection, $sql);
  $row = mysqli_fetch_object($result) ;
  echo  $row->total_name;
  mysqli_close($connection);
?>
  ...
  $sql = "SELECT COUNT(`subject_name`) AS total_name FROM `subject`";
  $result = mysqli_query($connection, $sql);
  $row = mysqli_fetch_object($result) ;
  echo  $row->total_name;
  mysqli_close($connection);
?>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-orange hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">Total Chapters</div>
                                                     <div class="number">
                            <?php
  include('conn.php');
  if(! $connection) {
  ...
  $sql = "SELECT COUNT(`chap_name`) AS total_name FROM `chapter`";
  $result = mysqli_query($connection, $sql);
  $row = mysqli_fetch_object($result) ;
  echo  $row->total_name;
  mysqli_close($connection);
