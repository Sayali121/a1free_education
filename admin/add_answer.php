                ...
                <ul class="list">
					...
					<li>
                      ...
                      <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="add_answer.php">Add Answers</a>
                            </li>
                            <li>
                                <a href="view_answer.php">View Answers</a>
                            </li>
							  ...
							  <div class="col-lg-3">
							   ...
							   <div class="row" style="margin-top:20px">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <label for="female" class="m-l-20">Option 2</label>
									
									<input type="radio" name="gender" id="female" class="with-gap">
                                    <label for="female" class="m-l-20">Option 3</label>
									
									<input type="radio" name="gender" id="female" class="with-gap">
                                    <label for="female" class="m-l-20">Option 4</label>
                                </div>
